        ...
        public List<object> consultarLista(object _o)
        {
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    personaTemp.FechaNacimiento = reader["fechaNacimiento"].ToString();
                    personaTemp.NumHermanos = int.Parse(reader["numHermanos"].ToString());
                    personaTemp.CarroElectronico = reader["carroElectronico"].ToString();
                    personaTemp.CodigoPostal = int.Parse(reader["codigoPostal"].ToString());
                    personaTemp.Rfc = reader["rfc"].ToString();
