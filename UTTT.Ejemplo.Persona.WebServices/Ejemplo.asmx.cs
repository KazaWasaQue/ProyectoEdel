    ...
    public class Ejemplo : System.Web.Services.WebService
    {
        ...
        public bool insertarPersona(UTTT.Ejemplo.Persona.Data.Entity.Persona _persona)
        {
            try
            {
                ...
                persona.fechaNacimiento = _persona.FechaNacimiento;
                persona.numHermanos = _persona.NumHermanos;
                persona.carroElectronico = _persona.CarroElectronico;
                persona.codigoPostal = _persona.CodigoPostal;
                persona.rfc = _persona.Rfc;
        ...
        public UTTT.Ejemplo.Persona.Data.Entity.Persona[] consultarGlobalPersona()
        {
            try
            {
                ...
                for (int i = 0; i < listaPersona.Count(); i++)
                {
                    ...
                    temp.FechaNacimiento = listaPersona[i].fechaNacimiento;
